...
class FileSpec extends FunSpec {
  describe("format 0 File") {
    ...
    **/
      val tsEvent = new Event(new TimeSignature(4, 2, 24, 8))
      val setTempoEvent = new Event(new SetTempo(500000))
      val programChange1 = new Event(new ProgramChange(0, 5))
      val programChange2 = new Event(new ProgramChange(1, 46))
      val programChange3 = new Event(new ProgramChange(2, 70))
      val noteOnEvent1 = new Event(new NoteOn(2,48, 96))
      val noteOnEvent2 = new Event(new NoteOn(2,60, 96))
      ...
      val noteOffEvent2 = new Event(new NoteOff(2,60, 64))
      val noteOffEvent3 = new Event(new NoteOff(1,67, 64))
      val noteOffEvent4 = new Event(new NoteOff(0,76, 64))
